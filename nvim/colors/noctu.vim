...
hi MatchParen          ctermbg=10  cterm=underline
...
hi Comment         ctermfg=8   term=italic
...
hi rustModPath            ctermfg=4
hi Macro                  ctermfg=2
hi plaintexControlSequence ctermfg=13
hi initexJobCommand ctermfg=13
